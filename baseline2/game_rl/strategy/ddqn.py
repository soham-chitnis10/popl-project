...
import random
from ..models.ddqn_network import DDQN_network
...
class Mario():
    ...
    def __init__(self, state_dim, action_dim, save_dir, bias_action=None):
        ...
        self.net = DDQN_network(self.state_dim, self.action_dim).float()
        ...
        self.save_every = 5e5  # no. of experiences between saving CNN Net
    ...
    def sync_Q_target(self):
        """
        Sync the parameters of target and online network
        """
